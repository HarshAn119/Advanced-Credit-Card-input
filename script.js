...
function onInputChange(input, newValue) {
  ...
  if (firstFour.startsWith('4')) {
    logo.src =
      'https://raw.githubusercontent.com/WebDevSimplified/css-js-credit-card/main/visa.svg';
  } else if (firstFour.startsWith('5')) {
    logo.src =
      'https://raw.githubusercontent.com/WebDevSimplified/css-js-credit-card/main/mastercard.svg';
  }
}
